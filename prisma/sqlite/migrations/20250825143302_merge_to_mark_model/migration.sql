...
CREATE TABLE "mark" (
    ...
    CONSTRAINT "mark_targetId_fkey" FOREIGN KEY ("targetId") REFERENCES "verse" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "mark_targetId_fkey" FOREIGN KEY ("targetId") REFERENCES "heading" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
