...
-- AddForeignKey
ALTER TABLE "mark" ADD CONSTRAINT "mark_targetId_verse_fkey" FOREIGN KEY ("targetId") REFERENCES "verse"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mark" ADD CONSTRAINT "mark_targetId_heading_fkey" FOREIGN KEY ("targetId") REFERENCES "heading"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
