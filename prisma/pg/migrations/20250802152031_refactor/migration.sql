...
/*
  ...
  - A unique constraint covering the columns `[code,language,source]` on the table `version` will be added. If there are existing duplicate values, this will fail.
...
CREATE TABLE "verse" (
    ...
    "text" TEXT NOT NULL,
    "paragraphNumber" INTEGER NOT NULL DEFAULT 1,
    "verseNumberOffset" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "version_code_language_source_key" ON "version"("code", "language", "source");
